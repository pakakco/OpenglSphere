...
public class Sphere {
    ...
    public Sphere(final Context context, final int depth, final float radius) {
        ...
        Log.d(TAG, "mTotalNumStrips = " + mTotalNumStrips);
        Log.d(TAG, "numVerticesPerStrip = " + numVerticesPerStrip);
        ...
        for (int stripNum = 0; stripNum < this.mTotalNumStrips; stripNum++) {
            ...
            Log.d(TAG, "altitude = " + altitude+", azimuth = "+azimuth+",stripNum = "+stripNum);
            ...
            for (int vertexNum = 0; vertexNum < numVerticesPerStrip; vertexNum += 2) {
                ...
                Log.d(TAG, "x = " + x+", y = "+y+",z = "+z+",vertexNum="+vertexNum);
                // First point - Texture.
    ...
    public void draw(float[] mvpMatrix) {
        ...
        for (int i = 0; i < this.mTotalNumStrips; i++) {
            ...
            GLES20.glDrawArrays(GLES20.GL_TRIANGLE_STRIP
                    , 0, this.mVertices.get(i).length / AMOUNT_OF_NUMBERS_PER_VERTEX_POINT);
